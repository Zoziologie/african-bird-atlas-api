...
function latlng2pentad(lat,lng){
	...
	var  latstr = (Math.floor(Math.abs(lat+0.0001)/res)*res*100).toLocaleString(undefined,{ 
		minimumIntegerDigits: 4, useGrouping: false, maximumFractionDigits:0 
	})
...
window.onload = function () {
	...
	app = new Vue({
		...
		data: {
			...
			format: "json",
			first: "",
			groups: [ {label:"Aberdare Range", code: "40147_AbrdrRng"}, {label:"Amboseli Landscape", code: "40147_AmbslLndscp"}, {label:"Arabuko-Sokoke Forest", code: "40147_Arbk-SkkFrst"}, {label:"Athi-Kaputiei Plains", code: "40147_Ath-KptPlns"}, {label:"Boni-Dodori Reserves", code: "40147_Bn-DrdRsrvs"}, {label:"Cherangani Hills", code: "40147_ChrngnHlls"}, {label:"Chyulu Hills", code: "40147_ChylHlls"}, {label:"Coast - North", code: "40147_NrthCst-KE"}, {label:"Coast - South", code: "40147_SthCst-KE"}, {label:"Dida-Galgalu Desert", code: "40147_Dd-GlglDsrt"}, {label:"Gwasi Hills", code: "40147_GwsHlls"}, {label:"Kakamega and Nandi Forests", code: "40147_KkmgndNndFrsts"}, {label:"Laikipia", code: "40147_Lkp"}, {label:"Lake Baringo", code: "40147_LkBrng"}, {label:"Lake Bogoria", code: "40147_LkBgr"}, {label:"Lake Elementaita", code: "40147_LkElmntt"}, {label:"Lake Magadi", code: "40147_LkMgd"}, {label:"Lake Naivasha", code: "40147_LkNvsh"}, {label:"Lake Nakuru", code: "40147_LkNkr"}, {label:"Lake Ol Bolossat", code: "40147_LkOlBlsst"}, {label:"Lake Turkana", code: "40147_LkTrkn"}, {label:"Lake Victoria", code: "40147_LkVctr"}, {label:"Loima Hills", code: "40147_LmHlls"}, {label:"Loita-Nguruman Hills", code: "40147_Lt-NgrmnHlls"}, {label:"Lorian Swamp", code: "40147_LrnSwmp"}, {label:"Masai Mara", code: "40147_GrtrMsMr"}, {label:"Matthews Range", code: "40147_MtthwsRng"}, {label:"Mau Forest Complex", code: "40147_MFrstCmplx"}, {label:"Meru-Kora-Rahole-Bisanadi Reserves", code: "40147_Mr-Kr-Rhl-BsndRsrvs"}, {label:"Mount Elgon", code: "40147_MntElgn-KE"}, {label:"Mount Kenya", code: "40147_MntKny"}, {label:"Mount Kulal", code: "40147_MntKll"}, {label:"Mount Marsabit", code: "40147_MntMrsbt"}, {label:"Mount Nyiru", code: "40147_MntNyr"}, {label:"Mount Suswa", code: "40147_MntSsw"}, {label:"Nairobi", code: "40147_Nrb"}, {label:"Ndoto Mountains", code: "40147_NdtMntns"}, {label:"Ngong Hills", code: "40147_NgngHlls"}, {label:"North-Eastern", code: "40147_Nrth-Estrn"}, {label:"Nyambene Hills", code: "40147_NymbnHlls"}, {label:"Sekerr Range (Mtelo)", code: "40147_SkrrRng(Mtl)"}, {label:"Shimba Hills", code: "40147_ShmbHlls"}, {label:"Tana River Delta", code: "40147_TnRvrDlt"}, {label:"Tana River Mid Section", code: "40147_TnRvrMddlSctn"}, {label:"Tsavo Parks", code: "40147_TsvEstndWst"}, {label:"Turkwel River", code: "40147_TrkwlRvr"} ],			regions: ['country','pentad','province','group','qdgc'],
			...
			displayMarkerPentad: false,
			marker_pentad: {
				position: { lat: -1.219482, lng: 38.953153 },
			},
			geojson: {
		...
		mounted() {
			var self = this;
			$.getJSON('http://kbm.raphaelnussbaumer.com/structure.json', 
			function (json) {
				self.structure = json;
			})
			$.getJSON('http://kbm.raphaelnussbaumer.com/species.json', 
			function (json) {
				self.species = json.map(l => { return { code: l[0], label: l[1] } });
			})
		...
		computed: {
			rectangle_pentad: function(){
				...
				return [[lat0, lng0], [lat0+res, lng0+res]]
			},
			base_opts: function(){
